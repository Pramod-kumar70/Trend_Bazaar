...
function Slider() {
  return (
    ...
    >
      <Carousel.Item>
        <Box component="img" src={img7} height="280px" width="100%" />
      </Carousel.Item>
      <Carousel.Item>
        <Box component="img" src={img4} height="280px" width="100%" />
      </Carousel.Item>
      <Carousel.Item>
        <Box component="img" src={img5} height="280px" width="100%" />
      </Carousel.Item>
      <Carousel.Item>
        <Box component="img" src={img3} height="280px" width="100%" />
      </Carousel.Item>
      <Carousel.Item>
        <Box component="img" src={img6} height="280px" width="100%" />
      </Carousel.Item>
      <Carousel.Item>
        <Box component="img" src={img2} height="280px" width="100%" />
      </Carousel.Item>
      <Carousel.Item>
        <Box component="img" src={img1} height="280px" width="100%" />
      </Carousel.Item>
    </Carousel>
  );
}
